...
export const leadContent = {
    ...
    paragraph: `${schoolName} offers full-time and part-time programs to provide students a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const threeStepCardText = {
    ...
    step2: {
        ...
        text: "Choose between the Full-Time Immersive and Part-Time Immersive programs."
    },
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKCFFT18",
    ...
    },
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKCFPT18",
        loanInfo: { // match loanInfo in first metro below
            maxLoanAmt: 22000,
            loanTerm36: true,
            loanTerm60: true,
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to your program's max (see table below) for the full-time and part-time programs."
